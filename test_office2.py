...
from dataset import ImageFolderInstance, ImageList_idx
...
def data_load(args): 
    ...
    txt_sour = open(args.s_dset_path).readlines()
...
def test_office(args):
    ...
    _, idx_list = torch.topk(dis_matrix, k=50, dim=1, largest=True)###(Nt, 50)
    acc=0
